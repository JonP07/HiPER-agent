...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.hgae.keep_penalty=-0.3 \
    ...
    algorithm.hgae.bootstrap_truncated=True \
    ...
    trainer.experiment_name="hiper_qwen2.5_1.5b_0.5b_seed_${SEED}_regterm_030_logging" \
    ...
    trainer.rollout_data_dir="/code/hongpaul-sandbox/temp/agent-hgae/alfworld_rollout_data/hiper_alfworld_qwen2.5_1.5b_0.5b_seed${SEED}" \
