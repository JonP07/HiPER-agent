...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.hgae.switch_rate_floor_coef=5.0 \
    algorithm.hgae.keep_consistency_penalty=-0.5 \
    ...
    trainer.experiment_name="hgae_qwen2.5_7b_seed_${SEED}_regterm_050_logging" \
    ...
    trainer.rollout_data_dir="/code/hongpaul-sandbox/temp/agent-hgae/alfworld_rollout_data/hgae_alfworld_qwen2.5_7b_1.5b_seed${SEED}" \
